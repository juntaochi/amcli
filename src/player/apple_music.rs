...
impl MediaPlayer for AppleMusicController {
    ...
    async fn get_player_status(&self) -> Result<PlayerStatus> {
        let script = r#"
            tell application "Music"
                ...
                if pState is not "stopped" then
                    ...
                    return pState & ":::BOLT_SPLIT:::" & pVolume & ":::BOLT_SPLIT:::" & trackName & ":::BOLT_SPLIT:::" & trackArtist & ":::BOLT_SPLIT:::" & trackAlbum & ":::BOLT_SPLIT:::" & trackDuration & ":::BOLT_SPLIT:::" & trackPos
                else
                    return pState & ":::BOLT_SPLIT:::" & pVolume & ":::BOLT_SPLIT:::"
                end if
            end tell
        "#;
        ...
        let volume: u8 = parts[1].parse().unwrap_or(50);
