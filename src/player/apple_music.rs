        ...
        let script = r#"
            tell application "Music"
                ...
                if pState is not "stopped" then
                    set tInfo to name of current track & ":::BOLT_SPLIT:::" & artist of current track & ":::BOLT_SPLIT:::" & album of current track & ":::BOLT_SPLIT:::" & duration of current track & ":::BOLT_SPLIT:::" & player position
