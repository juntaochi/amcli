...
impl App {
    ...
    pub async fn update(&mut self) -> Result<()> {
        ...
        if let Some(ref track) = self.current_track {
            ...
            // Bolt ⚡ Optimization:
            // Inline duration calculations directly into format! macros instead of using helper functions.
            // This avoids ~4 intermediate String heap allocations per UI update tick.
