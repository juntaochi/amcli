...
pub fn draw(f: &mut Frame, app: &mut App) {
    ...
    // Bolt ⚡ Optimization:
    // Replaced dynamic `vec![]` allocations and runtime `format!` macros
    // with static slice references containing pre-formatted string literals
    // to significantly reduce heap allocations during the high-frequency UI rendering loop.
